...
// Optional/deprecated keys are allowed to be unset.
const OPTIONAL_CONFIG_KEYS = new Set(["databaseId"]);

const initChecks = (config) => {
  for (const key in config) {
    if (OPTIONAL_CONFIG_KEYS.has(key)) continue;
