...
const { getAbsoluteRepoRoot } = require("./fs");
...
const initConfig = (args) => {
  ...
  _config.repoRoot = getAbsoluteRepoRoot(_config.repoRoot);
  _config.postsPath = `${_config.repoRoot}/${_config.postsDir}`;
  _config.draftsPath = `${_config.repoRoot}/${_config.draftsDir}`;
  _config.assetsPath = `${_config.repoRoot}/${_config.assetsDir}`;
